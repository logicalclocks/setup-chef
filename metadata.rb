...
recipe "setup::gemserver", "Installs and configures a gem server to host gem files"
...
attribute "setup/gemserver/port",
          :description => "Port on which gemserver should listen",
          :type => "string"
